...
public class Answers {
    ...
    {
        LO_Answers.add("-не кипишуй, осмотрись: тебе платят за ожид");
        LO_Answers.add("-через 5 минут начнется макрос **2:33-3:00 (utc-4)** - concentrate work ti");
        LO_Answers.add("-через 5 минут утренний **SILVER BULLET time 03:00-04:00 AM (utc");
        LO_Answers.add("-через 5 минут начнется макрос **4:03-4:50 (utc-4)** - в ближайшие 50 минут ты берешь ");
        LO_Answers.add("-чилл до AM. закрывай чарты! потрать следующие три часа на то угодно кроме ча");
    }
